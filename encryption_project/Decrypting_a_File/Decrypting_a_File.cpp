...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::string src = "C:\\ping_test\\f3enc.TXT";
	std::string dst = "C:\\ping_test\\f3encdec.TXT";

	std::wstring src_temp = std::wstring(src.begin(), src.end());
	std::wstring dst_temp = std::wstring(dst.begin(), dst.end());

	LPCWSTR pszSource = src_temp.c_str();
	LPCWSTR pszDestination = dst_temp.c_str();
